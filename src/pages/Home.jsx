...
const stats = [
  { value: '22', unit: 'YRS', label: 'ESTABLISHED 2002', icon: Activity },
  { value: '500', unit: 'SKU', label: 'PRECISION PRODUCTS', icon: Cpu },
  { value: '04', unit: 'LOC', label: 'REGIONAL FACILITIES', icon: ShieldCheck },
  { value: '100', unit: '%', label: 'CUSTOM CAPABLE', icon: Zap },
];
  ...
  return (
    <div className="bg-white text-[#0A0F1A]">
      ...
      <section className="relative min-h-[calc(100vh-75px)] md:min-h-[calc(100vh-83px)] flex items-center border-b border-[#E2E5EC] overflow-hidden bg-white">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-white via-white/82 to-white/12 pointer-events-none" />
        <div className="absolute inset-0 bg-[#0A0F1A]/5 pointer-events-none" />
        <div className="absolute inset-0 pointer-events-none opacity-20" style={{
          backgroundImage: `linear-gradient(#0A0F1A 1px, transparent 1px), linear-gradient(90deg, #0A0F1A 1px, transparent 1px)`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="w-[48px] h-[3px] bg-[#1B4EDB]" />
              <span className="text-[#1B4EDB] font-mono text-[10px] font-bold uppercase tracking-[0.3em]">REF_ID: 1024_IH_MFG</span>
            </div>

            <h1 className="font-heading text-[56px] sm:text-[76px] lg:text-[104px] leading-[0.9] font-extrabold text-[#0A0F1A] mb-8 sm:mb-10 tracking-tight">
              BUILT FOR<br />
              <span className="text-[#1B4EDB] drop-shadow-sm">HEAT.</span><br />
              BUILT TO<br />
              <span className="text-[#1B4EDB] drop-shadow-sm">LAST.</span>
            </h1>

            <p className="text-[#3A3F4B] text-base sm:text-lg leading-[1.8] mb-10 sm:mb-12 max-w-md font-body font-medium">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/products"
                className="btn-industrial bg-[#1B4EDB] text-white px-8 sm:px-10 py-5 font-heading font-bold text-sm uppercase tracking-[0.2em] hover:bg-[#1340B5] transition-all flex items-center gap-3"
              >
                Catalog Access <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                to="/enquiry"
                className="btn-industrial border-2 border-[#0A0F1A] bg-white/70 text-[#0A0F1A] px-8 sm:px-10 py-5 font-heading font-bold text-sm uppercase tracking-[0.2em] hover:bg-[#0A0F1A] hover:text-white transition-all"
              >
                Request Quote
              </Link>
            </div>
      ...
      <div className="border-b border-[#E2E5EC] overflow-hidden bg-[#1B4EDB] py-3 h-14 flex items-center">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 border-l-4 border-[#1B4EDB] pl-8">
          <div>
            <div className="text-[#1B4EDB] font-mono text-[10px] font-bold uppercase tracking-[0.3em] mb-4">SYSTEM_CATALOGUE_V2.0</div>
            <h2 className="font-heading text-6xl font-bold text-[#0A0F1A] leading-tight">PRECISION<br />HEATING RANGE</h2>
          </div>
          <Link to="/products" className="mt-8 md:mt-0 flex items-center gap-3 text-xs font-mono font-bold uppercase tracking-[0.2em] text-[#1B4EDB] hover:gap-6 transition-all group">
            EXPAND ALL MODULES <ArrowRight className="w-4 h-4 group-hover:translate-x-1 duration-300" />
          </Link>
        </div>
              ...
              <Link to={`/products?category=${cat.slug}`} className="block h-full">
                ...
                <div className="h-64 bg-white overflow-hidden relative border-b border-[#E2E5EC] flex items-center justify-center p-10">
                  ...
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute bottom-4 left-4 font-mono text-[8px] text-[#C9CDD8] opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
                    CAT_ID: 00{idx + 1}_SPEC
                  </div>
                </div>
                {/* Text area */}
                <div className="p-8 bg-white group-hover:bg-[#F5F5F5] transition-all duration-300">
                  <h3 className="font-heading text-2xl font-bold text-[#0A0F1A] mb-3 group-hover:text-[#1B4EDB] transition-colors tracking-tight">{cat.name}</h3>
                  <p className="text-sm text-[#6B7280] mb-6 leading-[1.6] h-12 overflow-hidden border-l border-[#E2E5EC] pl-4 font-body">{cat.desc}</p>
                  <div className="flex items-center gap-3 text-[#1B4EDB] text-[10px] font-mono font-bold uppercase tracking-[0.2em]">
                    VIEW_MODULE <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-2 transition-transform" />
                  </div>
                </div>
              </Link>
            </motion.div>
      ...
      <section className="bg-[#0A0F1A] border-t-8 border-[#1B4EDB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/10">
            {stats.map((stat, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4 text-[#1B4EDB]">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  ...
                  <div className="font-mono text-sm font-bold text-[#1B4EDB]">{stat.unit}</div>
                </div>
      ...
      <section className="border-b border-[#E2E5EC] bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="py-24 pr-0 lg:pr-20 border-r border-[#E2E5EC] structural-line-left pl-12 lg:pl-16">
            <div className="text-[#1B4EDB] font-mono text-[10px] font-bold uppercase tracking-[0.3em] mb-4">SYSTEM_PHILOSOPHY</div>
            <h2 className="font-heading text-5xl font-bold text-[#0A0F1A] leading-[1.1] mb-8 tracking-tight">PRECISION.<br />EXPERIENCE.<br />UNWAVERING TRUST.</h2>
            ...
            <Link to="/about" className="btn-industrial inline-flex items-center gap-3 text-sm font-mono font-bold uppercase tracking-[0.2em] text-[#1B4EDB] hover:gap-6 transition-all">
              LEARN_ENGINEERING_PROCESS <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="hidden lg:block bg-[#F5F5F5] relative overflow-hidden group">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-[#1B4EDB]/10 to-transparent pointer-events-none" />
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-b border-[#E2E5EC]">
        <h2 className="font-heading text-[10px] font-bold uppercase tracking-[0.4em] text-[#6B7280] mb-12 flex items-center gap-6">
          <span className="shrink-0">ACTIVE_INDUSTRIAL_SECTORS</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 border border-[#E2E5EC]">
          {industries.map((ind, i) => (
            <span
              key={i}
              className="px-8 py-6 font-mono text-[11px] font-bold uppercase tracking-widest text-[#3A3F4B] border-b border-r border-[#E2E5EC] hover:bg-[#1B4EDB] hover:text-white transition-all duration-300 cursor-default group flex justify-between items-center"
            >
              {ind}
      ...
      {/* ── CTA BANNER BRUTE ─────────────────────────── */}
      <section className="bg-[#1B4EDB] py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <p className="text-white/80 leading-[1.8] max-w-md font-body text-lg" style={{ fontFamily: 'DM Sans, sans-serif' }}>
          ...
          <div className="flex lg:justify-end">
            <Link
              to="/enquiry"
              className="btn-industrial bg-white text-[#1B4EDB] px-12 py-6 font-heading font-bold text-lg uppercase tracking-[0.2em] shadow-2xl hover:bg-[#EBF0FF] transition-all flex items-center gap-4"
            >
              INITIALIZE ENQUIRY <ArrowRight className="w-6 h-6" />
            </Link>
          </div>
        </div>
      </section>
