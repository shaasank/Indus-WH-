    ...
    <div className="bg-white text-[#0A0F1A]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[#1B4EDB] font-heading text-xs font-bold uppercase tracking-[0.2em]">Our Story</span>
            </div>
            <h1 className="font-heading text-6xl font-bold leading-none mb-6">
              PRECISION.<br />
              <span className="text-[#1B4EDB]">EXPERIENCE.</span><br />
              TRUST.
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 border-b border-[#E2E5EC]">
        <div className="flex items-center gap-3 mb-10">
          <div className="w-6 h-[2px] bg-[#1B4EDB]" />
          <span className="text-[#1B4EDB] font-heading text-xs font-bold uppercase tracking-[0.2em]">History</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border border-[#E2E5EC]">
          {timeline.map((item, i) => (
            <div key={i} className="p-8 border-b sm:border-b-0 lg:border-r border-[#E2E5EC] last:border-r-0 group hover:bg-[#EBF0FF] transition-colors">
              <div className="font-heading text-4xl font-bold text-[#1B4EDB] mb-2">{item.year}</div>
              <div className="font-heading text-lg font-bold text-[#0A0F1A] mb-3 uppercase tracking-wide">{item.label}</div>
              <p className="text-sm text-[#6B7280] leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif' }}>{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 border-b border-[#E2E5EC]">
        <div className="flex items-center gap-3 mb-10">
          <div className="w-6 h-[2px] bg-[#1B4EDB]" />
          <span className="text-[#1B4EDB] font-heading text-xs font-bold uppercase tracking-[0.2em]">Values</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 border border-[#E2E5EC]">
          {values.map((v, i) => (
            <div key={i} className="p-10 border-b md:border-b-0 md:border-r border-[#E2E5EC] last:border-0">
              <div className="w-8 h-[3px] bg-[#1B4EDB] mb-5" />
              <h3 className="font-heading text-2xl font-bold mb-3">{v.title}</h3>
              <p className="text-sm text-[#6B7280] leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif' }}>{v.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="flex items-center gap-3 mb-10">
          <div className="w-6 h-[2px] bg-[#1B4EDB]" />
          <span className="text-[#1B4EDB] font-heading text-xs font-bold uppercase tracking-[0.2em]">Locations</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-[#E2E5EC]">
          {locations.map((loc, i) => (
            <div key={i} className="p-8 border-b md:border-b-0 md:border-r border-[#E2E5EC] last:border-0">
              <MapPin className="w-5 h-5 text-[#1B4EDB] mb-3" />
              <h3 className="font-heading text-xl font-bold mb-1">{loc.city}</h3>
              <p className="text-sm text-[#6B7280] mb-4" style={{ fontFamily: 'DM Sans, sans-serif' }}>{loc.address}</p>
              <div className="flex items-center gap-2 text-sm text-[#3A3F4B] mb-2"><Phone className="w-3.5 h-3.5 text-[#1B4EDB]" /> {loc.phone}</div>
              <div className="flex items-center gap-2 text-sm text-[#3A3F4B]"><Mail className="w-3.5 h-3.5 text-[#1B4EDB]" /> {loc.email}</div>
            </div>
          ))}
        </div>
      </section>
